...
pydoc:
	@$(call MESSAGE,$@)
	install -d doc/pydoc
	$(PYTHON) -m pydoc -w dice/*.py
	mv *.html doc/pydoc

pdoc:
	@$(call MESSAGE,$@)
	pdoc --force --html --output-dir doc/pdoc dice/*.py
...
radon-cc:
	@$(call MESSAGE,$@)
	radon cc --show-complexity --average dice
