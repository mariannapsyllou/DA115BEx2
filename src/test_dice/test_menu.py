...
class TestMenus(unittest.TestCase):
    ...
    def test_main_menu(self):
        ...
        self.assertEqual(main_menu(), output)

    @patch('builtins.input', side_effect=['name1', 'name2'])
    def test_two_player_names(self, mock_input):
    ...
    def test_single_player_name_and_difficulty(self, mock_set_difficulty, mock_input):
        player1, difficulty = single_player_menu()
